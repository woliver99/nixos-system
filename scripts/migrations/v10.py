...
TITLE="Flatpak, Bitwarden Option"
...
def run(console):
    ...
    structural_warnings = {
        "/modules/features/flatpak.nix": "You need to use maple.profiles.flatpak.enable instead for flatpaks.",
        "/modules/features/bitwarden-ssh-agent.nix": "You need to use maple.profiles.bitwarden.enable instead for bitwarden.",
    }
