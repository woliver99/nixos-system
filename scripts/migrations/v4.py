...
def run(console):
    console.print("[cyan]Running Migration: Updating Nixvim profile paths...[/cyan]")
    
    # 1. Define the target paths (escaping regex characters where necessary)
    search_pattern = r'\./nixos-system/presets/editor/nixvim/wayland\.nix'
    replace_string = r'./nixos-system/presets/editor/nixvim'
    ...
    try:
        ...
        console.print("[green]✅ Nixvim paths updated successfully.[/green]")
        return True
