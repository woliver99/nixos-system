...

{
  imports = [
    ...
    ./nixos-system/presets/editor/nixvim/wayland.nix # Import your editor preset here (nano is installed by default)
    ./nixos-system/presets/display-manager/gnome.nix # Import your desktop environment here
    ./nixos-system/presets/apps/developer.nix # Import your apps preset here (options: essentials, full, developer)
    ...
    ./nixos-system/features/printers # Adds support for most printers
    ./nixos-system/features/printers/epson.nix # Adds drivers for epson printers
